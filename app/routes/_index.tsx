...
export default function Index() {
  ...
  return (
    <div id="body" className=" max-w-2xl p-8 ml-10 flex flex-col space-y-4">
          ...
          <RecipeDetails prepTimeMinutes={4} cookTimeMinutes={5} totalTimeMinutes={10} servings={2} yieldServings={3}/>
          <RecipeIngredients ingredients={["4 eggs", "1/4 milk", "1/8 teaspoon salt"]}/>
          <RecipeDirections steps={directions}/>
